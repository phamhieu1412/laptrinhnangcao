...
public class Coupon {
	...
	Integer count;
	Boolean is_enable;
	public Coupon(String id, String code, String description, Float discount, Float max_value, LocalDateTime valid_from,
			LocalDateTime valid_until, Integer count, Boolean is_enable) {
		super();
		this.id = id;
		this.code = code;
