...
<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	<%
		...
		User kh = KhachHangDAO.mapKhachHang.get(id);
	%>
<!DOCTYPE html>
<html>
<head>
...
<!-- validation form -->
	...
	<script>
		jQuery(document).ready(function(){
			...
			jQuery("#addcustomerID").validationEngine();
		});
	</script>
...
<body>
	<div class="container">
		<div class="row">
			<h2><strong>Sửa khách hàng</strong>
		...
		<div class="">
		  	...
		  	<div class="form-center">
		          <form  class="form-horizontal" action="Process?chucNang=Edit&makh=<%=kh.getId()%> " method="post" id="editcustomerID">
		            <div class="form-group">
		              <label class="control-label col-sm-2" for=""><span class=""></span> Tên Khách hàng:</label>
		              	 ...
		              	 <div class="col-sm-10">
					               		<div class="row">
					               			<div class="col-sm-8">
						             			  <input type="text" class="form-control"  value="<%=kh.getName() %>" id="name" name="tenKH" placeholder="Tên khách hàng">
					               			</div>
					               			<div class="col-sm-2">
												<p id="icon-name"></p>
					               			</div>
		            ...
		            <div class="form-group">
		              <label class="control-label col-sm-2" for=""><span class=""></span> Tài khoản:</label>
		              	 <div class="col-sm-10">
		               		<div class="row">
		               			<div class="col-sm-8">
		               				 <input type="text" class="form-control"  value="<%=kh.getUsername()%>" name="tkkh" placeholder="Nhập tài khoản" id="account">
		               			</div>
		               			<div class="col-sm-2">
									<p id="icon-account"></p>
		               			</div>
		            ...
		            <div class="form-group">
		              <label class="control-label col-sm-2" for=""><span class=""></span> Mật khẩu:</label>
		                   <div class="col-sm-10">
		                  	<div class="row">
		               			<div class="col-sm-8">
		               				  <input type="password" class="form-control"  value="<%=kh.getPassword() %>" name="pass" placeholder="Nhập mật khẩu" id="matkhau">
		               			</div>
		               			<div class="col-sm-2">
									<p id="icon-pass"></p>
		               			</div>
		            ...
		            <div class="form-group">
		              <label class="control-label col-sm-2" for=""><span class=""></span> Số điện thoại:</label>
		              	<div class="col-sm-10">
		               		<div class="row">
		               			<div class="col-sm-8">
		               				 <input type="text" class="form-control"  value="<%=kh.getPhone()%>" name="sdt" placeholder="Nhập vào số điện thoại" id="phone">
		               			</div>
		               			<div class="col-sm-2">
									<p id="icon-phone"></p>
		               			</div>
